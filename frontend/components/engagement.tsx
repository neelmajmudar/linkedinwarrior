...
export default function Engagement() {
  ...
  const STATUS_BADGE: Record<string, string> = {
    ...
    posted: "bg-[var(--success)]/10 text-[var(--success)] border-[var(--success)]/20",
    failed: "bg-red-500/10 text-red-500 border-red-500/20",
    skipped: "bg-[var(--muted-foreground)]/10 text-[var(--muted-foreground)] border-[var(--muted-foreground)]/20",
  };
      ...
      {showHistory ? (
        ...
        <>
          ...
          <div className="glass-card p-4 space-y-3">
            <h3 className="text-sm font-medium">Engagement Topics</h3>
            <div className="flex flex-wrap gap-2">
              {topics.map((topic) => (
                <span
                  key={topic}
                  className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[var(--primary)]/10 text-[var(--primary)] text-sm border border-[var(--primary)]/20"
                >
                  {topic}
                  <button
              ...
              {topics.length === 0 && !loading && (
                <span className="text-sm text-[var(--muted-foreground)] opacity-60">
                ...
                >
                  ...
                  <div className="pl-3 border-l-2 border-[var(--primary)]/30">
                    {editingId === preview.comment_id ? (
                      ...
                      <p className="text-sm">{preview.comment_text}</p>
                    )}
                  </div>
                      ...
                      {editingId === preview.comment_id ? (
                        <>
                          ...
                          <button
                            ...
                            className="btn-ghost px-3 py-1.5 text-xs border border-[var(--border)] rounded-lg"
                          >
                            Cancel
                          </button>
                        </>
                        ...
                        <>
                          ...
                          <button
                            ...
                            className="btn-ghost px-3 py-1.5 text-xs flex items-center gap-1.5 border border-[var(--border)] rounded-lg"
                          >
                          ...
                          <button
                            ...
                            className="btn-ghost px-3 py-1.5 text-xs flex items-center gap-1.5 border border-[var(--border)] rounded-lg text-[var(--muted-foreground)]"
                          >
                            <X className="h-3 w-3" />
                            Skip
                          </button>
